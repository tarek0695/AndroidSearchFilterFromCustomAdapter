...
public class ListAdapter extends BaseAdapter implements Filterable{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // by ListView is null.
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.custom_listview_layout, null);

            // Creates a ViewHolder and store references to the two children views
            // we want to bind data to.
            holder = new ViewHolder();

            holder.text1  = (TextView) convertView.findViewById(R.id.conversation_tv);
            holder.text2 = (TextView) convertView.findViewById(R.id.category);
        ...
        holder.text2.setText(conversationCategory);
